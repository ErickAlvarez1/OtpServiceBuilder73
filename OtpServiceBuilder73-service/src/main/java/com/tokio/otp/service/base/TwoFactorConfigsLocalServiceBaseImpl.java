...
/**
 * Provides the base implementation for the two factor configs local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.tokio.otp.service.impl.TwoFactorConfigsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.tokio.otp.service.impl.TwoFactorConfigsLocalServiceImpl
 * @generated
 */
public abstract class TwoFactorConfigsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TwoFactorConfigsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TwoFactorConfigsLocalServiceUtil</code>.
	 */
	...
	public TwoFactorConfigs addTwoFactorConfigs(
		...
		return twoFactorConfigsPersistence.update(twoFactorConfigs);
	}
	...
	public TwoFactorConfigs createTwoFactorConfigs(long twoFactorConfigsId) {
		return twoFactorConfigsPersistence.create(twoFactorConfigsId);
	}
	...
	public TwoFactorConfigs deleteTwoFactorConfigs(long twoFactorConfigsId)
		...
		return twoFactorConfigsPersistence.remove(twoFactorConfigsId);
	}
	...
	public TwoFactorConfigs deleteTwoFactorConfigs(
		...
		return twoFactorConfigsPersistence.remove(twoFactorConfigs);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TwoFactorConfigs.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return twoFactorConfigsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return twoFactorConfigsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return twoFactorConfigsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return twoFactorConfigsPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TwoFactorConfigs fetchTwoFactorConfigs(long twoFactorConfigsId) {
		return twoFactorConfigsPersistence.fetchByPrimaryKey(
			twoFactorConfigsId);
	}
	...
	public TwoFactorConfigs getTwoFactorConfigs(long twoFactorConfigsId)
		...
		return twoFactorConfigsPersistence.findByPrimaryKey(twoFactorConfigsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TwoFactorConfigs.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("twoFactorConfigsId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TwoFactorConfigs.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return twoFactorConfigsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return twoFactorConfigsLocalService.deleteTwoFactorConfigs(
			(TwoFactorConfigs)persistedModel);
	}

	public BasePersistence<TwoFactorConfigs> getBasePersistence() {
		return twoFactorConfigsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return twoFactorConfigsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TwoFactorConfigs> getTwoFactorConfigses(int start, int end) {
		return twoFactorConfigsPersistence.findAll(start, end);
	}
	...
	public int getTwoFactorConfigsesCount() {
		return twoFactorConfigsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TwoFactorConfigsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		twoFactorConfigsLocalService = (TwoFactorConfigsLocalService)aopProxy;

		_setLocalServiceUtilService(twoFactorConfigsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TwoFactorConfigsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = twoFactorConfigsPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TwoFactorConfigsLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, twoFactorConfigsLocalService);
		}
	...
	protected TwoFactorConfigsLocalService twoFactorConfigsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TwoFactorConfigsLocalServiceBaseImpl.class);
