...
/**
 * Provides the local service utility for DebugEMails. This utility wraps
 * <code>com.tokio.otp.service.impl.DebugEMailsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DebugEMailsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.tokio.otp.service.impl.DebugEMailsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DebugEMails addDebugEMails(DebugEMails debugEMails) {
		return getService().addDebugEMails(debugEMails);
	}
	 ...
	 */
	public static DebugEMails createDebugEMails(long debugEMailsId) {
		return getService().createDebugEMails(debugEMailsId);
	}
	 ...
	 */
	public static DebugEMails deleteDebugEMails(DebugEMails debugEMails) {
		return getService().deleteDebugEMails(debugEMails);
	}
	 ...
	 */
	public static DebugEMails deleteDebugEMails(long debugEMailsId)
		throws PortalException {

		return getService().deleteDebugEMails(debugEMailsId);
	}
	...
	public static boolean existEMail(String email) {
		return getService().existEMail(email);
	}

	public static DebugEMails fetchDebugEMails(long debugEMailsId) {
		return getService().fetchDebugEMails(debugEMailsId);
	}
	 ...
	 * @throws PortalException if a debug e mails with the primary key could not be found
	 */
	public static DebugEMails getDebugEMails(long debugEMailsId)
		throws PortalException {

		return getService().getDebugEMails(debugEMailsId);
	}
	 ...
	 */
	public static List<DebugEMails> getDebugEMailses(int start, int end) {
		return getService().getDebugEMailses(start, end);
	}
	 ...
	 */
	public static int getDebugEMailsesCount() {
		return getService().getDebugEMailsesCount();
	}
	 ...
	 */
	public static DebugEMails updateDebugEMails(DebugEMails debugEMails) {
		return getService().updateDebugEMails(debugEMails);
	}

	public static DebugEMailsLocalService getService() {
		return _service;
	}

	private static volatile DebugEMailsLocalService _service;
