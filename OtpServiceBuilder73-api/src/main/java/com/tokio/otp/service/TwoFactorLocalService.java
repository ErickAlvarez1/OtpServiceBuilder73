...
/**
 * Provides the local service interface for TwoFactor. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TwoFactorLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TwoFactorLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.tokio.otp.service.impl.TwoFactorLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the two factor local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TwoFactorLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TwoFactor addTwoFactor(TwoFactor twoFactor);

	public TwoFactor addTwoFactorUser(
	...
	public TwoFactor createTwoFactor(long twoFactorId);
	...
	public TwoFactor deleteTwoFactor(long twoFactorId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TwoFactor deleteTwoFactor(TwoFactor twoFactor);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TwoFactor fetchTwoFactor(long twoFactorId);

	public TwoFactor generateToken(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TwoFactor getTokenByUsuario(
		long userId, long companyId, long groupId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TwoFactor getTwoFactor(long twoFactorId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TwoFactor> getTwoFactors(int start, int end);
	...
	public TwoFactor updateTokenUser(
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TwoFactor updateTwoFactor(TwoFactor twoFactor);
