...
/**
 * Provides the local service utility for TwoFactor. This utility wraps
 * <code>com.tokio.otp.service.impl.TwoFactorLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TwoFactorLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.tokio.otp.service.impl.TwoFactorLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TwoFactor addTwoFactor(TwoFactor twoFactor) {
		return getService().addTwoFactor(twoFactor);
	}

	public static TwoFactor addTwoFactorUser(
		long userId, long companyId, long groupId) {

		return getService().addTwoFactorUser(userId, companyId, groupId);
	}
	 ...
	 */
	public static TwoFactor createTwoFactor(long twoFactorId) {
		return getService().createTwoFactor(twoFactorId);
	}
	 ...
	 */
	public static TwoFactor deleteTwoFactor(long twoFactorId)
		throws PortalException {

		return getService().deleteTwoFactor(twoFactorId);
	}
	 ...
	 * @return the two factor that was removed
	 */
	public static TwoFactor deleteTwoFactor(TwoFactor twoFactor) {
		return getService().deleteTwoFactor(twoFactor);
	}
	...
	public static TwoFactor fetchTwoFactor(long twoFactorId) {
		return getService().fetchTwoFactor(twoFactorId);
	}

	public static TwoFactor generateToken(
		long userId, long companyId, long groupId, int expirationMinutes) {

		return getService().generateToken(
	...
	public static TwoFactor getTokenByUsuario(
		long userId, long companyId, long groupId) {

		return getService().getTokenByUsuario(userId, companyId, groupId);
	}
	 ...
	 * @throws PortalException if a two factor with the primary key could not be found
	 */
	public static TwoFactor getTwoFactor(long twoFactorId)
		throws PortalException {

		return getService().getTwoFactor(twoFactorId);
	}
	 ...
	 */
	public static List<TwoFactor> getTwoFactors(int start, int end) {
		return getService().getTwoFactors(start, end);
	}
	 ...
	 */
	public static int getTwoFactorsCount() {
		return getService().getTwoFactorsCount();
	}

	public static TwoFactor updateTokenUser(
		long twoFactorId, String token, int expirationMinutes) {

		return getService().updateTokenUser(
	 ...
	 */
	public static TwoFactor updateTwoFactor(TwoFactor twoFactor) {
		return getService().updateTwoFactor(twoFactor);
	}

	public static TwoFactorLocalService getService() {
		return _service;
	}

	private static volatile TwoFactorLocalService _service;
