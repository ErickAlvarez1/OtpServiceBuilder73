...
/**
 * Provides the local service utility for TwoFactorConfigs. This utility wraps
 * <code>com.tokio.otp.service.impl.TwoFactorConfigsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TwoFactorConfigsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.tokio.otp.service.impl.TwoFactorConfigsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TwoFactorConfigs addTwoFactorConfigs(
		TwoFactorConfigs twoFactorConfigs) {

		return getService().addTwoFactorConfigs(twoFactorConfigs);
	}
	 ...
	 */
	public static TwoFactorConfigs createTwoFactorConfigs(
		long twoFactorConfigsId) {

		return getService().createTwoFactorConfigs(twoFactorConfigsId);
	}
	 ...
	 */
	public static TwoFactorConfigs deleteTwoFactorConfigs(
			long twoFactorConfigsId)
		throws PortalException {

		return getService().deleteTwoFactorConfigs(twoFactorConfigsId);
	}
	...
	public static TwoFactorConfigs deleteTwoFactorConfigs(
		...
		return getService().deleteTwoFactorConfigs(twoFactorConfigs);
	}
	...
	public static TwoFactorConfigs fetchTwoFactorConfigs(
		long twoFactorConfigsId) {

		return getService().fetchTwoFactorConfigs(twoFactorConfigsId);
	}
	 ...
	 * @throws PortalException if a two factor configs with the primary key could not be found
	 */
	public static TwoFactorConfigs getTwoFactorConfigs(long twoFactorConfigsId)
		throws PortalException {

		return getService().getTwoFactorConfigs(twoFactorConfigsId);
	}
	 ...
	 */
	public static List<TwoFactorConfigs> getTwoFactorConfigses(
		int start, int end) {

		return getService().getTwoFactorConfigses(start, end);
	}
	 ...
	 */
	public static int getTwoFactorConfigsesCount() {
		return getService().getTwoFactorConfigsesCount();
	}

	public static boolean isActiveConfig(
		String configName, long companyId, long groupId) {

		return getService().isActiveConfig(configName, companyId, groupId);
	}
	 ...
	 */
	public static TwoFactorConfigs updateTwoFactorConfigs(
		TwoFactorConfigs twoFactorConfigs) {

		return getService().updateTwoFactorConfigs(twoFactorConfigs);
	}

	public static TwoFactorConfigsLocalService getService() {
		return _service;
	}

	private static volatile TwoFactorConfigsLocalService _service;
